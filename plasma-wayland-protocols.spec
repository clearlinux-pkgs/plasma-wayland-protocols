...
Source0  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.12.0.tar.xz
Source1  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.12.0.tar.xz.sig
...
%prep
%setup -q -n plasma-wayland-protocols-1.12.0
cd %{_builddir}/plasma-wayland-protocols-1.12.0
