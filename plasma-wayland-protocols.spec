...
Source0  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.16.0.tar.xz
Source1  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.16.0.tar.xz.sig
...
%setup -q -n plasma-wayland-protocols-1.16.0
cd %{_builddir}/plasma-wayland-protocols-1.16.0
pushd ..
cp -a plasma-wayland-protocols-1.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736477202
mkdir -p clr-build
pushd clr-build
