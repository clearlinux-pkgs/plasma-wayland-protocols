...
Source0  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.11.1.tar.xz
Source1  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.11.1.tar.xz.sig
...
%prep
%setup -q -n plasma-wayland-protocols-1.11.1
cd %{_builddir}/plasma-wayland-protocols-1.11.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699977634
mkdir -p clr-build
pushd clr-build
