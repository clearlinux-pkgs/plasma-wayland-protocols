...
Source0  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.6.0.tar.xz
Source1  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.6.0.tar.xz.sig
...
%prep
%setup -q -n plasma-wayland-protocols-1.6.0
cd %{_builddir}/plasma-wayland-protocols-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642090748
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-wayland-protocols-1.6.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/plasma-wayland-protocols-1.6.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/plasma-wayland-protocols-1.6.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/plasma-wayland-protocols-1.6.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/plasma-wayland-protocols-1.6.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/plasma-wayland-protocols-1.6.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/plasma-wayland-protocols-1.6.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/plasma-wayland-protocols-1.6.0/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/plasma-wayland-protocols/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
pushd clr-build
%make_install
popd
