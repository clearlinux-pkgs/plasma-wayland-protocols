...
Source0  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.11.0.tar.xz
Source1  : https://download.kde.org/stable/plasma-wayland-protocols/plasma-wayland-protocols-1.11.0.tar.xz.sig
...
%prep
%setup -q -n plasma-wayland-protocols-1.11.0
cd %{_builddir}/plasma-wayland-protocols-1.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699464066
mkdir -p clr-build
pushd clr-build
